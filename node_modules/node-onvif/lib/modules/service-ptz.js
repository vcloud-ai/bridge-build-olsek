...
OnvifServicePtz.prototype.getRequestParams = function() {
...
OnvifServicePtz.prototype.getNodes = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNodes', soap).then((result) => {
			try {
...
OnvifServicePtz.prototype.getNode = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		soap_body += '</tptz:GetNode>';
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNode', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.getConfigurations = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetConfigurations', soap).then((result) => {
			try {
...
OnvifServicePtz.prototype.getConfiguration = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetConfiguration', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.getConfigurationOptions = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetConfigurationOptions', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.getStatus = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetStatus', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.continuousMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		soap_body += '</tptz:ContinuousMove>';
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'ContinuousMove', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.absoluteMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'AbsoluteMove', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.relativeMove = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'RelativeMove', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.stop = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'Stop', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.gotoHomePosition = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GotoHomePosition', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.setHomePosition = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetHomePosition', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.setPreset = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetPreset', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.getPresets = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetPresets', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.gotoPreset = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GotoPreset', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServicePtz.prototype.removePreset = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'RemovePreset', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
