...
OnvifServiceDevice.prototype.getRequestParams = function() {
...
OnvifServiceDevice.prototype.getCapabilities = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetCapabilities', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getWsdlUrl = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetWsdlUrl', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getDiscoveryMode = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetDiscoveryMode', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getScopes = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetScopes', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setScopes = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetScopes', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.addScopes = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'AddScopes', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.removeScopes = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'RemoveScopes', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getHostname = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetHostname', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setHostname = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetHostname', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getDNS = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetDNS', soap).then((result) => {
			try {
...
OnvifServiceDevice.prototype.setDNS = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetDNS', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getNetworkInterfaces = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNetworkInterfaces', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getNetworkProtocols = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNetworkProtocols', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setNetworkProtocols = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		soap_body += '</tds:SetNetworkProtocols>';
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetNetworkProtocols', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getNetworkDefaultGateway = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNetworkDefaultGateway', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setNetworkDefaultGateway = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetNetworkDefaultGateway', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getDeviceInformation = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetDeviceInformation', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getSystemDateAndTime = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetSystemDateAndTime', soap).then((result) => {
...
OnvifServiceDevice.prototype.setSystemDateAndTime = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetSystemDateAndTime', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.reboot = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SystemReboot', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getUsers = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetUsers', soap).then((result) => {
			try {
...
OnvifServiceDevice.prototype.createUsers = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'CreateUsers', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.deleteUsers = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'DeleteUsers', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setUser = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetUser', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getRelayOutputs = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetRelayOutputs', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getNTP = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetNTP', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setNTP = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetNTP', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getDynamicDNS = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetDynamicDNS', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getZeroConfiguration = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetZeroConfiguration', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getIPAddressFilter = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetIPAddressFilter', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.setIPAddressFilter = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'SetIPAddressFilter', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getServices = function(params, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetServices', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceDevice.prototype.getServiceCapabilities = function(callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetServiceCapabilities', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
